...
function BlogCard() {
  return (
    <article className=" has-thumbnail bg-white ml-14 rounded-lg shadow-2xl shadow-stone-600 overflow-hidden h-[338px] w-[900px] ">
        <div className=' flex  '>
      ...
      <div className=' mt-5 ml-7'>
        ...
        <h2 className=' mt-5 font-semibold  text-3xl overflow-hidden text-ellipsis '
        style={{
            display: '-webkit-box',
            WebkitLineClamp: 2,
        ...
        <div className=' mt-10'>
            <div className='flex space-x-2 text-sm text-teal-900 syne-font'>
